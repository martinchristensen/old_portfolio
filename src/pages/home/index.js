...
const Home = () => {
    ...
    const pointerSomething = (e, cube) => {
        cube===null?setCursor(e):setCursor(false)
    }
    ...
    return (
        <>
            ...
            <Canvas className={cursor?"full-size-canvas pointer":"full-size-canvas"} shadows={true}>
                <ThreeScene pointer={pointerSomething} />
            </Canvas>
        </>
    );
};
